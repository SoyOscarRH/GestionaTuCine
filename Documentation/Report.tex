...
\clearpage
    ...
    \section{Modelo Relacional}
        ...
        % =============================================
        \subsection{Diagramas con WorkBench}

            \begin{figure}[h]
                \centering
                \includegraphics[width=0.95\textwidth]{DataBase/DiagramTables.png}
            \end{figure}
        ...
        \subsection{Codigo en SQL}
            ...
            \lstinputlisting[language=SQL,linerange={1-46}]
            {DataBase/DataBaseTables.sql}
            \clearpage

            \lstinputlisting[language=SQL,linerange={48-81}]
            {DataBase/DataBaseTables.sql}
            \clearpage

            \lstinputlisting[language=SQL,linerange={84-136}]
            {DataBase/DataBaseTables.sql}
            \clearpage

            \lstinputlisting[language=SQL,linerange={139-191}]
            {DataBase/DataBaseTables.sql}
    ...
    \section{Casos de Usos}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.95\textwidth]{DiagramaSecuencial}
        \end{figure}
