<?php
    ...
    // ======================================================================
        ...
        $UsedStops = array();                                                                   //Dime cuantos lugares
        ...
        foreach ($PossibleFunctions as $ID) {                                                   //Para cada ID
            ...
            if (!$QueryTemporal) $UsedStops[$ID] = 0;                                           //Si no habia nadie
            else {$Row = $QueryTemporal->fetch_row(); $UsedStops[$ID] = $Row[0];}               //Sino se lo pones       
        }
            ...
            <div id="CardFindFunction" name="CardFindFunction" class="card-content">
                ...
                <ul class="collapsible" data-collapsible="accordion">
                    ...
                    <?php while ($Function = $QueryFunctionInfo->fetch_assoc()) : 
                        $Function['Stock'] = $Function['NumeroAsientos'] - $UsedStops[$Function['ID']];
                    ?>
                    <!-- ========  MOVIE ITME ================ -->
                    <li>
